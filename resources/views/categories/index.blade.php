            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    @if ($categories->isEmpty())
                        <p class="text-gray-600">No categories found. Click "Add New Category" to get started.</p>
                    @else
                                    ...
                                    @foreach ($categories as $category)
                                        <tr>
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                                <a href="{{ route('categories.show', $category->id) }}" class="text-indigo-600 hover:text-indigo-900 mr-3">View</a>
                                                <a href="{{ route('categories.edit', $category->id) }}" class="text-green-600 hover:text-green-900 mr-3">Edit</a>
